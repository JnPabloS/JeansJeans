...
<head>
	...
	<script type="text/javascript" src="js/carrito.js?n=1"></script>
...
<body>
	...
	<?php
		...
		if(sizeof(json_decode($_SESSION['carrito'],1))==0){
	...
	<h1 class="text-center carrito-tittle">Mi carrito de compras</h1>
	<div class="container">
			<div id="carrito-div">
				<div id="tabla">
				</div>
